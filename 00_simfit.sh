...
prepsims_jid=$(sbatch --parsable 10_prepsims.slurm)

qdevscalingsim_jid=$(sbatch --parsable --dependency=afterok:$prepsims_jid 21_runsims_qdevscaling.slurm)
...
# sharedqsim_jid=$(sbatch --parsable --dependency=afterok:$prepsims_jid 22_runsims_sharedq.slurm)
...
prefintensitysim_jid=$(sbatch --parsable --dependency=afterok:$prepsims_jid 23_runsims_prefintensity.slurm)
...
densdepqsim_jid=$(sbatch --parsable --dependency=afterok:$prepsims_jid 24_runsims_densdepq.slurm)
